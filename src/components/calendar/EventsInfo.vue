<template>
  <content class="box">
    ...
    <table class='table'>
      ...
      <tr>
        <td>Jeudi soir</td>
        <td>Sortie informelle sur le Mont-Royal (sans encadrement ni chef de peloton)</td>
      </tr>
      <tr>
        <td>Samedi matin</td>
        <td>Sortie plus longue avec départ de Montréal ou en région par covoiturage.</td>
      </tr>
    </table>
